...
_lr_productions = [
  ...
  ('expression -> expression PLUS expression','expression',3,'p_expression_plus','test.py',42),
  ('expression -> expression MINUS expression','expression',3,'p_expression_minus','test.py',47),
  ('expression -> expression TIMES expression','expression',3,'p_expression_times','test.py',52),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_divide','test.py',57),
  ('expression -> NUMBER','expression',1,'p_expression_number','test.py',62),
]
